...
function assignWasmExports(wasmExports) {
  ...
  __emscripten_tempret_set = wasmExports["wc"];
  ...
  dynCall_ji = dynCalls["ji"] = wasmExports["Ac"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Bc"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Cc"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Dc"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Ec"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["Fc"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["Gc"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["Hc"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["Ic"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["Jc"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["Kc"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Lc"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Mc"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Nc"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Oc"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Pc"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["Qc"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["Rc"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["Sc"];
...
var wasmImports = {
  ...
  /** @export */ oa: __embind_register_bigint,
  ...
  /** @export */ p: __embind_register_function,
  /** @export */ n: __embind_register_integer,
  /** @export */ u: __embind_register_iterable,
  ...
  /** @export */ J: _emscripten_stack_snapshot,
  ...
  /** @export */ ia: _emwgpuDeviceCreateComputePipelineAsync,
  /** @export */ wa: _emwgpuDeviceCreateShaderModule,
  /** @export */ va: _emwgpuDeviceDestroy,
  /** @export */ ha: _emwgpuQueueOnSubmittedWorkDone,
  ...
  /** @export */ ga: _wgpuBufferGetSize,
  /** @export */ fa: _wgpuBufferGetUsage,
  /** @export */ z: _wgpuCommandEncoderBeginComputePass,
  /** @export */ A: _wgpuCommandEncoderClearBuffer,
  /** @export */ ea: _wgpuCommandEncoderCopyBufferToBuffer,
  /** @export */ ba: _wgpuCommandEncoderCopyBufferToTexture,
  /** @export */ aa: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ r: _wgpuCommandEncoderFinish,
  /** @export */ da: _wgpuCommandEncoderResolveQuerySet,
  /** @export */ I: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ y: _wgpuComputePassEncoderEnd,
  /** @export */ $: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ H: _wgpuComputePassEncoderSetPipeline,
  /** @export */ _: _wgpuDeviceCreateBindGroup,
  /** @export */ Z: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ q: _wgpuDeviceCreateCommandEncoder,
  /** @export */ Y: _wgpuDeviceCreateComputePipeline,
  /** @export */ X: _wgpuDeviceCreatePipelineLayout,
  /** @export */ W: _wgpuDeviceCreateQuerySet,
  /** @export */ V: _wgpuDeviceCreateTexture,
  /** @export */ G: _wgpuDeviceGetAdapterInfo,
  /** @export */ U: _wgpuDeviceGetLimits,
  /** @export */ T: _wgpuDeviceHasFeature,
  /** @export */ o: _wgpuQueueSubmit,
  /** @export */ ca: _wgpuQueueWriteBuffer,
  /** @export */ S: _wgpuQueueWriteTexture,
  /** @export */ R: _wgpuTextureCreateView,
  /** @export */ Q: _wgpuTextureGetDepthOrArrayLayers,
  /** @export */ x: _wgpuTextureGetHeight,
